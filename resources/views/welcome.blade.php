...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/dist/css/adminlte.css') }}"><!--end::Required Plugin(AdminLTE)-->
...
<body class="login-page bg-body-secondary">
    ...
    <script src="{{ asset('public/dist/js/adminlte.js') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
